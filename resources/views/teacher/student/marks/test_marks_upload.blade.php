		     ...
		     <div class="panel panel-default">
                <div class="panel-heading"><button class="btn btn-primary btn-block">Upload Student Marks</button></div>
                 <div class="panel-body">
                   ...
                   <form action="/teacher/student/test_amrks/{{$course['id']}}/{{strtotime($course['created_at'])}}/{{$section['id']}}/{{strtotime($section['created_at'])}}/{{$subject['id']}}/{{strtotime($subject['created_at'])}}/{{$test['id']}}/{{strtotime($test['created_at'])}}/upload" method="POST" data-parsley-validate ="">
                    {{ csrf_field() }}
                     ...
                     <div class="col-sm-4 col-sm-offset-4">
                      <a class="btn-block btn-warning btn" href="/teacher/student/{{$course['id']}}/{{ $section['id'] }}/test_subject">BACK</a>
                     </div>
		     	 </div>
		    @else
