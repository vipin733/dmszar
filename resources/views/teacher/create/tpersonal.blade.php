      ...
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="Example@example.com" data-parsley-type="email" required="">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="date_pic" name="date_of_joining" value="{{ old('date_of_joining',Carbon\Carbon::today()->format('d/m/Y')) }}" placeholder="ex 22/12/2015" required="">
      </div>
