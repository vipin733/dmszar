...
@section('content')
    ...
    <div class="row">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading text-center"><b>My Time Table({{ $activesessionid['name'] }})</b></div>
				            ...
				            @foreach($timetables as $timetable)
				              <tr class="text-center">
				                  ...
				                  <td>{{$timetable['end']->format('h:i A')}}</td>
				                   <td>
				                     @if($timetable->sunday_teacher_id == Auth::id())
				                  ...
				                  <td>
				                    @if($timetable->monday_teacher_id == Auth::id())
				                  ...
				                  <td>
				                    @if($timetable->tuesday_teacher_id == Auth::id())
				                  ...
				                  <td>
				                      @if($timetable->wednesday_teacher_id == Auth::id())
				                  ...
				                  <td>
				                      @if($timetable->thursday_teacher_id == Auth::id())
				                  ...
				                  <td>
				                     @if($timetable->friday_teacher_id == Auth::id())
				                  ...
				                  <td>
				                    @if($timetable->saturday_teacher_id == Auth::id())
        ...
        <div class="col-md-6 col-md-offset-3 text-center">
        	<a href="/teacher/timetable/print" class="btn btn-warning ">Print</a>    
        </div>
