...
<div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            Total registration fee collection({{ $asession['name'] }})
         </button>
        </div>
    ...
    <div class="col-md-8">
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            Search registration fee transaction({{ $asession['name'] }})
         </button>
        </div>
        <div class="panel-body">
...
<script type="text/javascript">
   var oTable = $('#registration_fee').DataTable({
     ...
     dom: 'Bfrtip',
        ...
        serverSide: true,
        ajax: {
            url: '/staff/fee_analysis/registraion_transactions/ajax',
            data: function (d) {
        ...
        columns: [
                      ...
                      {data: 'download_registraion_fee', name: 'download_registraion_fee', orderable: false, searchable: false},
