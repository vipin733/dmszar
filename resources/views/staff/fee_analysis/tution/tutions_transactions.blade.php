 ...
 <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            Total tuition fee collection({{ $asession['name'] }})
         </button>
        </div>
    ...
    <div class="col-md-8">
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            Search tuition fee collection({{ $asession['name'] }})
         </button>
        </div>
        <div class="panel-body">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
         All tuition fee transactions({{ $asession['name'] }})
         </button>
        </div>
        <div class="panel-body">
            ...
            <table class=" table table-bordered  table-hover" id="tution_fees">
              <thead>
                <tr>
                  ...
                  <th class="col-sm-1 text-center">Download</th>
                </tr>
              </thead>
            </table>
          </div>
...
<script type="text/javascript">
   var oTable = $('#tution_fees').DataTable({
     ...
     dom: 'Bfrtip',
        ...
        serverSide: true,
        ajax: {
            url: '/staff/fee_analysis/tutions_transactions/ajax',
            data: function (d) {
        ...
        columns: [
                      ...
                      { data: 'download_tuition_fee', name: 'download_tuition_fee', orderable: false, searchable: false},
