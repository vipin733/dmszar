                ...
                <div class="panel-body">
	                ...
	                <div class="col-sm-12 text-center" id="sandbox-container">
                      ...
                      <div class="form-group">
                        ...
                        <a class="btn btn-warning" href="/notification/index">Refresh</a>
                      </div>
	                 ...
	                 <div class="col-sm-12">
	                  @foreach($notifications as $not)
      				        <a href="/notification/show/{{$not->id}}/{{$not->slug}}"><h4>{{ $not->title }}</h4></a>
      				        <p class="pull-right">Posted at {{ $not->created_at->format('d/m/Y h:i A') }}</p>
      				        <p>{{ $not->notifications_categories['name'] }} @if(Auth::user()->isStaff())<a href="/staff/notification/edit_form/{{$not->id}}/{{$not->slug}}">Edit</a>@endif</p>
				       @endforeach
	                 </div>
