...
<div class="row">
  ...
  <div class="col-md-12">
	...
	<div class="col-sm-12 col-md-12">
	  <div class="panel panel-default">
	    <div class="panel-heading">
	    <button class="btn btn-primary btn-block">Student Last Registration Fee Transactions</button>
	    </div>
	    <div class="panel-body">
        <div class="table-responsive">
             ...
             <?php $i++ ?>
              <tr class="text-center">
                  ...
                  <td>  
                   ...
                   <td>  
                    <a class="btn btn-warning btn-xs" href="/staff/student/receipt/{{$registraionfee['id']}}/{{ strtotime($registraionfee->created_at) }}/fee/registration/download">
