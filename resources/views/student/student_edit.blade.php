...
@section('content')
  ...
  <div class="row">
     <form class="form-horizontal" method="POST" action="/student/profile/{{ $student->uuid }}/{{$student->reg_no}}/update" data-parsley-validate ="" enctype="multipart/form-data">
            ...
            <div class="panel panel-primary">
             ...
             <div class="panel-body">
                <div class="col-sm-10 col-sm-offset-1">
                  @include('student.edit.sprofile_edit')
                </div>  
             </div>  
            </div>   
         </div>
