...
@section('content')
  ...
  @if($user->schoolprofile['transport_service'])
    @if($user->appprofile['reg_prefix_student'])
     <form class="form-horizontal" id="" role="" method="POST" action="{{ url('/student/register') }}" data-parsley-validate ="" enctype="multipart/form-data">
                        {{ csrf_field() }}
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
             ...
             <div class="panel-body">
                <div class="col-sm-10 col-sm-offset-1">
                  @include('student.create.sprofile')
                </div>  
             </div>  
            </div>   
         </div>
         ...
         <div class="col-md-12">
          ...
          <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary">
                <div class="panel-heading">Student Bio(if any)</div>
                <div class="panel-body">
