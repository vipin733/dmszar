...
@section('content')
  ...
  <div class="col-md-4 col-md-offset-4 col-xs-8 col-xs-offset-2">
         ...
         <a href="/student/transport/fee_detail/{{$transportfee->asessions['id']}}/{{strtotime($transportfee->asessions['created_at'])}}" class="btn btn-warning"><i class="fa fa-backward faa-passing-reverse animated" aria-hidden="true"></i> Back</a>

         <a href="/student/transport/{{$transportfee['id']}}/{{strtotime($transportfee['created_at'])}}/fee_receipt/print" class="btn btn-primary"><i class="fa fa-print faa-pulse animated" aria-hidden="true"></i> Print
         </a>
         
          <a href="/student/transport/{{$transportfee['id']}}/{{strtotime($transportfee['created_at'])}}/fee_receipt/download" class="btn btn-success"><i class="fa fa-download faa-vertical animated" aria-hidden="true"></i> Save
        </a>
 <br><br>
  </div>
 </div>
