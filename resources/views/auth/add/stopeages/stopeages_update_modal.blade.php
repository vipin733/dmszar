  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update stoppage details form</h4>
      </div>
      <div class="modal-body">
          
        <form method="POST" action="{{ route('stopages_auth.update',$stopeage->id) }}" data-parsley-validate ="">
        {{ csrf_field() }} {{ method_field('PATCH') }}
          ...
          <div class="form-group">
           <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-plus faa-flash animated" aria-hidden="true"></i> Submit</button>
          </div>
