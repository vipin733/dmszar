  ...
  <div class="col-sm-10 col-sm-offset-1">
    <div class="panel panel-default">
              <div class="panel-heading">
               <button class="btn btn-primary btn-block">Academic Profile({{ $studentacadmic->students['name'] }})
               </button>
              </div>
                        ...
                        <table class="table table-bordered  table-hover">
                           <thead>
                             <tr>
                                 ...
                                 <a href="/student/{{$studentacadmic->students['reg_no']}}">
                               ...
                               <tr>
                                 ...
                                 <td class="text-center">
                                 {{  $studentacadmic->courses->teacheracadmic->teachers['name'] }}
                                 </td>
