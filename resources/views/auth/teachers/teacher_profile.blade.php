...
@section('content')
    ...
    <div class="col-sm-2 col-sm-offset-5">
        <a href="#" class="thumbnail">
           @if($teacher->avatar)
            <img src="{{ $teacher->avatar }}" class="img-responsive img-rounded" alt="{{$teacher->name}}" height="512" width="512">
          @else
            <img src="https://s3.ap-south-1.amazonaws.com/dbmszar/assets/images/student_male.png" class="img-responsive img-rounded" alt="{{$teacher->name}}" height="512" width="512">
          @endif
        </a>
      </div>
       ...
       <div class="col-md-10 col-md-offset-1">
        ...
        <div class="col-md-4 col-md-offset-4">
          <a href="/teacher/profile/{{$teacher->uuid}}/{{$teacher->reg_no}}/update" class="btn btn-primary btn-block btn-lg">Update Profile</a>
          <br>
       </div>
