...
class AllStudentsViewController extends Controller
{
    ...
    {        
        $students = Student::where('user_id',Auth::user()->owner->id)->count();
        ...
        return view('staff.students.students',compact('students','sessions'));
    }
