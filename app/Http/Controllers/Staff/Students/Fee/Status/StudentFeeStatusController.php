...
namespace App\Http\Controllers\Staff\Students\Fee\Status;
...
class StudentFeeStatusController extends Controller
{
    ...
    {   
        ...
        $user= Student::where('uuid',$uuid)->where('reg_no',$reg_no)->where('user_id',$userID)->with('courses','hostels','stopages')->first(); 
       ...
       if ($registration_fee) {                              
        ...
        return view('staff.students.fee.status.fee_status',compact('user','registraionfee','registration_fee','totalpaidRfee','tutionfee','tution_fee','totalpaidTUfee','transportfee','transport_fee','totalpaidTTfee','hostelfee','hostel_fee','totalpaidHfee','activesessionid'));
    }
}
